...
/// The eleven commands plus `constants`.
///
...
mod tests {
    ...
    /// Twelve subcommands, named as the manifest and the response table name them.
    #[test]
    fn the_tree_registers_the_eleven_python_commands_plus_constants() {
